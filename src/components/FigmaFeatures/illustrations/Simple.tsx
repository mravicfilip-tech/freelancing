...
export const simpleMotion: IllustrationMotion = {
  ...
  idle(gsap, il) {
    ...
    // swap turns as it passes, another €10 lands on the receipt with a flick, and the toast nods.
    ...
    const send = () => {
      gsap
        ...
        .fromTo(amount, { color: '#4042d2' }, { color: '#000', duration: 1.4, ease: 'power1.out' }, 1.95)
